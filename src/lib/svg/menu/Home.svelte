<script lang="ts">
    export let color: string = "#aaa";
    export let size = 20;
</script>

<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 254.182 254.182" style="enable-background:new 0 0 254.182 254.182;" height={size} width={size} fill={color} xml:space="preserve" >
	<g>
